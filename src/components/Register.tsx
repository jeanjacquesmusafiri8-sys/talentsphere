...
export default function Register({ onSwitchToLogin, theme, lang }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name || !email || !password) {
      setError(lang === "fr" ? "Veuillez remplir tous les champs requis." : "Please fill in all required fields.");
      return;
    }
    ...
    try {
      ...
      setError(err?.message || (lang === "fr" ? "Échec d'inscription." : "Failed to register."));
    } finally {
      setLoading(false);
    }
  };
  ...
  const text = {
    fr: {
      ...
      subtitle: "Créez votre dossier cloud TalentSphere AI",
      nameLabel: "Nom Complet",
      emailLabel: "Adresse Email",
      passwordLabel: "Mot de passe (Min 6)",
      btnAction: "S'enregistrer",
    ...
    en: {
      ...
      subtitle: "Setup your public TalentSphere AI cloud wallet",
      nameLabel: "Full Name",
      emailLabel: "Email Address",
      passwordLabel: "Password (Min 6)",
      btnAction: "Create Profile",
      googleBtn: "Join via Google",
      ...
      <div className={`p-8 border rounded-none shadow-2xl relative overflow-hidden ${
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-2">
            <div className="p-1 px-1.5 bg-emerald-600 text-white rounded-none text-[10px] font-mono font-bold tracking-widest uppercase">
              TS_REG
            </div>
        ...
        {/* Premium Google Unified Sign-Up Option */}
        <button
          type="button"
        ...
        <div className="mt-6 text-center">
          <p className="text-[10px] font-mono text-zinc-500">
            ...
            <button
              ...
              type="button"
              className="text-emerald-500 hover:text-emerald-400 font-bold underline transition-colors cursor-pointer"
            >
              {text.signInLink}
            </button>
          </p>
